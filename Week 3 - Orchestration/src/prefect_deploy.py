...
def main(train_path = './data/green_tripdata_2021-01.parquet',
    ...
    X_train = read_dataframe(train_path,
                            ...
                            drop_off_time='lpep_dropoff_datetime',
                            pu_id ='PULocationID',
                            do_id='DOLocationID').result()
    X_val = read_dataframe(test_path,
                           pickup_time="lpep_pickup_datetime",
                            drop_off_time='lpep_dropoff_datetime',
                            pu_id ='PULocationID',
                            do_id='DOLocationID').result()

    X_train, X_val , y_train, y_eval, dv =  add_features(X_train, X_val).result()
...
# /Users/dsn/Downloads/MLOps_Zoomcamp/Week 3 - Orchestration/src/prefect_deploy.py